...
| Network policy and exposure | P0 | Overlay/NAT, stable service VIP/DNS, durable per-node nftables load balancing, and real TCP forwarding test exist | Ingress/egress policy, MTU validation, and real multi-node overlay/service qualification |
