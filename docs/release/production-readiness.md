...
| Node lifecycle | P0 | Certificate-identity-bound join, lease fencing, cordon/drain, revision/lease/assignment-safe removal, replacement runbook, and removal integration test exist | Automated certificate renewal and full replacement qualification |
