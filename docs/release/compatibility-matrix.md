...
| Glider API | Struct-based `glider.v1`; typed `glider.v2` is Candidate | Immutable-baseline breaking check and reproducible generated-client compilation; mixed-version qualification required before v2 becomes Current |
