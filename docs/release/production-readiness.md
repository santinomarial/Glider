...
| Performance qualification | P1 | Published baseline sizing, saturation signals, p99 operational SLO, mean/allocation guards, and exact-commit throughput plus p50/p95/p99 reports for simulated 100/1,000-node scheduling and 1,000-endpoint discovery exist | Real runtime cold/warm lifecycle and release-hardware multi-host load/saturation qualification |
